          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-3 md:p-8 md:p-12 relative overflow-hidden">
              ...
              <p className="text-sm text-white/60 leading-relaxed mb-8 max-w-sm">
                Choose a topic below and we&apos;ll open a pre-filled WhatsApp
                message straight to our signage team.
              </p>
                ...
                {actions.map((action, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* WhatsApp icon */}
                      <svg
                        className="w-5 h-5 text-emerald-400 group-hover:text-white shrink-0 transition-colors duration-200"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
            ...
            <div className="p-3 md:p-12 bg-white/[0.03] border-t lg:border-t-0 lg:border-l border-white/10 flex flex-col justify-between gap-10">
              ...
              <div className="flex flex-col gap-5">
                ...
                {contactDetails.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[11px] text-white/40 uppercase tracking-wider font-bold mb-0.5">
                        {item.label}
                      </p>
                      {item.href ? (
                        <a
              ...
              <Button
                href={getWhatsAppLink(
                  "Hello! I'd like to get in touch with Signage World.",
                )}
                target="_blank"
                rel="noopener noreferrer"
                variant="primary"
